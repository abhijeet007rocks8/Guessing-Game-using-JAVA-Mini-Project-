import java.util.*;
public class GuessingGameComputer
{
      static int lower=0;
      static int upper=100;
    public static int computerGuess(int l,int h)
    {
        return ((l+h)/2);
    }
    ...
    public static void main(String[] args)
    {
      ...
      while(ch=='Y')
      {
        ...
        while(chances>0)  //while attempts are less than 10
        {
            ...
            int guess=computerGuess(lower,upper);
            System.out.println(guess+ " Guessed by computer.");
